    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center ">
              <div className="space-y-2 ">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-7xl p-5 ">
                  Automate Your Social Media Success with Soci Ai
                </h2>
                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed mx-auto ">
                  Unlock a suite of powerful tools to effortlessly create engaging social media content with the precision of Ai
                </p>
              </div>
              <Link
                  href="#"
        ...
        <p className="text-xs text-muted-foreground">
          &copy; 2024 <b>Soci Ai.</b> All rights reserved.
        </p>
